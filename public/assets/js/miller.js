...
(function ($) {
    ...
    $.fn.millerColumn = function (options) {
        ...
        if ("addCol" == args[0]) {
            ...
            if (null != listParentAddedItem) {
                ...
                if (!parentAlreadyWithChildren) {
                    listParentAddedItem.append($("<i/>").addClass("material-icons").text(">").addClass("has-children"));
                }
            }
        ...
        function buildColListItem(item, readOnly) {
            ...
            if (item.hasChildren)
                millerColListItem.append($("<i/>").addClass("material-icons").text(">").addClass("has-children"));
