<script>
   function saveReport() {
        ...
        if($('#company_dropdown').combobox('getValue') > 0 && $('#cluster_dropdown').combobox('getValue') > 0) { 
            document.getElementById('myFrame').setAttribute('src','http://88.249.18.205:8445/jasperPhpEcoman/master/index.php?IndustrialZoneId='+$('#company_dropdown').combobox('getValue')+'&Rapor_ID=12&ClusterId='+$('#cluster_dropdown').combobox('getValue'));
            //document.getElementById('myFrame').setAttribute('src','http://88.249.18.205:8445/jasperPhpEcoman/master/index.php?company_id=132&Rapor_ID=3');
                ...
                noty({text: '<?php echo lang("Validation.selectzoneandcluster"); ?>', type: 'warning'});
        }
    }
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('admin/rpEmployeesList'); ?>"><?php echo lang("Validation.reportemployeelink"); ?></a>
					</li>
				</ul>
			</div>
			...
			<div class="sortable row-fluid">
				...
				<a data-rel="tooltip" title="" class="well span3 top-block" href="#">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i><?php echo lang("Validation.notypickindustrialzoneandcompany"); ?> </h2>
						<div class="box-icon">
							...
							<!--<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>-->
                                        ...
                                        <div class="box-content" style='padding: 0px;'>
                                                <div id="p2" class="easyui-panel" style="height:250px;" title="<?php echo lang("Validation.notypickindustrialzoneandcompany"); ?>" 
