<script>
    function updateReport() {
        ...
        $('#ff').form({
            ...
            success:function(data){
                ...
                {
                    if(jsonObj["id"]>0) {
                         noty({text: '<?php echo lang("Validation.notyreportupdated"); ?>', type: 'success'});
                         $('#tt_grid').datagrid('reload');
                         $.messager.progress('close');
                     } else {
                         noty({text: '<?php echo lang("Validation.notyreportinsertedbefore"); ?>', type: 'warning'});
                         $('#tt_grid').datagrid('reload');
                         $.messager.progress('close');
                     }
                    ...
                    noty({text: '<?php echo lang("Validation.notyreportnotupdated"); ?>', type: 'error'}); 
        ...
        if(typeof checkedArray !== 'undefined' && checkedArray.length > 0) {
            ...
            $('#ff').form({
                ...
                success:function(data){
                    ...
                    {
                        if(jsonObj["id"]>0) {
                             noty({text: '<?php echo lang("Validation.notyreportinserted"); ?>', type: 'success'});
                             $('#tt_grid').datagrid('reload');
                             $.messager.progress('close');
                         } else {
                             noty({text: '<?php echo lang("Validation.notyreportinsertedbefore"); ?>', type: 'warning'});
                        ...
                        //$.messager.alert('Save Error', 'Error occured');
                        noty({text: '<?php echo lang("Validation.notyreportnotinserted"); ?>', type: 'error'}); 
                        $.messager.progress('close');	// hide progress bar while submit successfully
                    }
                ...
                noty({text: '<?php echo lang("Validation.notyselectreportattribute"); ?>', type: 'warning'});
        }
    ...
    jQuery(document).ready(function() {
         ...
         $('#tt_grid').datagrid({
            ...
            scroll : true,
            columns:[[
                  {field:'report_name',title:'<?php echo lang("Validation.report"); ?>',width:100,sortable:true},
                  {field:'r_date',title:'<?php echo lang("Validation.reportdate"); ?>',width:100,sortable:true},
                  {field:'company_name',title:'<?php echo lang("Validation.company"); ?>',width:100,sortable:true},
                  {field:'company_id',title:'<?php echo lang("Validation.company"); ?> ID',width:100,sortable:true,hidden:true},
                  {field:'user_name',title:'<?php echo lang("Validation.username"); ?>',width:100},
                  {field:'name',title:'<?php echo lang("Validation.name"); ?>',width:100},
                  {field:'surname',title:'<?php echo lang("Validation.surname"); ?>',width:100},
                  {field:'report',title:'<?php echo lang("Validation.report"); ?>',width:100,align:'center',
                    formatter:function(value,row,index){
                        ...
                        var x = '<a href="#add" class="easyui-linkbutton" \n\
                                    ...
                                    \'http://88.249.18.205:8445/jasperPhpEcoman/master/index.php?Configuration_ID='+row.id+'&Rapor_ID=1\')"><?php echo lang("Validation.seereport"); ?></a>';
                        //return e+d;
                        return x;        
                ...
                {field:'edit',title:'Edit',width:50,align:'center',
                    formatter:function(value,row,index){
                        ...
                        var x = '<a href="" class="easyui-linkbutton" \n\
                                    iconCls="icon-save" \n\
                                    onclick="reportEditView(\''+row.report_name+'\','+row.id+', \''+row.company_name+'\', '+row.company_id+' );event.preventDefault();"><?php echo lang("Validation.edit"); ?></a>';
                        //return e+d;
                        return x;
				...
				<!--<a class="brand" href=""> <img style="height: 60px;width: 164px;" alt="ECOMAN logo" src="../assets/images/anasayfa.png" /> <span>ECOMAN</span></a>-->
                                ...
                                <div style="float:left;
                                    ...
                                    <ul class="nav navbar-nav navbar-left ust-nav" style=" 
                                        ...
                                        <li class="navtus" data-rel="reporting"><a style="border:0px;font-size:18px;color:white;" id="l5" href="<?php echo base_url('allreports'); ?>" ><span style="margin-top:4px;" class="icon16 icon-white icon-list-alt"></span> <?php echo lang("Validation.reporting"); ?></a></li>
                                    </ul>
                                </div> 
	...
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('createreport'); ?>"><?php echo lang("Validation.createreport"); ?></a>
					</li>
				</ul>
			</div>
			...
			<div class="sortable row-fluid">
				...
				<a data-rel="tooltip" title="" class="well span3 top-block" href="#">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i><?php echo lang("Validation.reportattr"); ?></h2>
						<div class="box-icon">
					...
					<div class="box-content" style='padding: 0px;'>
							...
							<div class="easyui-panel" title="<?php echo lang("Validation.reportattr"); ?>"  style="height:250px;" data-options="">
                                ...
                                <div class="box span8">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i><?php echo lang("Validation.savereport"); ?> </h2>
						<div class="box-icon">
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<!--<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>-->
						</div>
                                        ...
                                        <div class="box-content" style='padding: 0px;'>
                                                <div id="p2" class="easyui-panel" style="height:250px;" title="<?php echo lang("Validation.notywritereportnameandcompany"); ?>" 
                                                      ...
                                                      <form id="ff" method="post">
                                                        <div style="padding:10px 60px 20px 60px">
                                                            <div style="margin-bottom: 4px;margin-left: -8px;">
                                                                <label style="margin-right:18px;"><?php echo lang("Validation.report"); ?>:</label>
                                                            ...
                                                            <div style="margin-left:-8px;">
                                                                <label style="margin-right: 17px;
                                                                                padding-bottom: 3px;"><?php echo lang("Validation.company"); ?>:</label>
                                                    ...
                                                    <div data-options="region:'south',border:false" style="text-align:left;padding:5px 0 0;">
                                                        ...
                                                        <a class="easyui-linkbutton" id="saveReport" name="saveReport"
                                                           ...
                                                           onclick="saveReport();" style=""><?php echo lang("Validation.savereport"); ?></a>
                                                        <a class="easyui-linkbutton" id="updateReport" name="updateReport"
                                                           style='margin-left: 7px;'
                                                           data-options="iconCls:'icon-ok',disabled:true" 
                                                           href="javascript:void(0)" 
                                                           onclick="updateReport();" style=""><?php echo lang("Validation.updatereport"); ?></a>
                        ...
                        <div class="row-fluid sortable">
                            <div class="box span12">
                                    <div class="box-header well" data-original-title>
                                            <h2><i class="icon-th"></i><?php echo lang("Validation.allreports"); ?> </h2>
                                            <div class="box-icon">
                                        ...
                                        <div class="row-fluid" >
                                            ...
                                            <div class="span12">
                                                <div id="p2" class="easyui-panel"  
                                                     title="<?php echo lang("Validation.reportsalreadyprepared"); ?>" 
                                                     style="margin: auto 0;height:350px;"
                                                    data-options="iconCls:'icon-save',collapsible:true,closable:true">
                                                    <table id="tt_grid" data-options="" 
                                                           title="<?php echo lang("Validation.companyreportsets"); ?>" 
		...
		<div class="modal hide fade" id="myModal">
			...
			<div class="modal-body">
				<p><?php echo lang("Validation.totalproducts"); ?>Here settings can be configured...</p> 
			</div>
			<div class="modal-footer">
				<a href="#" class="btn" data-dismiss="modal"><?php echo lang("Validation.totalproducts"); ?>Close</a>
				<a href="#" class="btn btn-primary"><?php echo lang("Validation.totalproducts"); ?>Save changes</a>
			</div>
		</div>
