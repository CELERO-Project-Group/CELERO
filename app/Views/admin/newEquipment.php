            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                  ...
                  if(data["found"]==true) {
                      ...
                      if(data["id"]>0) {
                          noty({text: '<?php echo lang("Validation.notyequipmentinserted"); ?>', type: 'success'});
                          $('#tt_tree_equipment').tree('reload');
                      } else {
                          noty({text: '<?php echo lang("Validation.notyequipmentinsertedbefore"); ?>', type: 'warning'});
                          $('#tt_tree_equipment').tree('reload');
                      }
                  } else if(data["found"]==false) {         
                      //$.messager.alert('Insert failed','Failed to insert Equipment !','error');
                      noty({text: '<?php echo lang("Validation.notyequipmentnotinserted"); ?>', type: 'error'});  
                      $('#tt_tree_equipment').tree('reload');
                  }   
                },
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('admin/newEquipment'); ?>"><?php echo lang("Validation.equipmentslink"); ?></a>
					</li>
				</ul>
			</div>
                        ...
                        <div class="row-fluid sortable">
                            <div class="box span12">
                                    <div class="box-header well" data-original-title>
                                            <h2><i class="icon-th"></i><?php echo lang("Validation.insertequip"); ?>  </h2>
                                            <div class="box-icon">
                                    ...
                                    <div class="box-content">
                                        <div class="row-fluid">
                                            <div class="span4">
                                                <div class="easyui-panel" title="<?php echo lang("Validation.equip"); ?>" style="width:400px;height:auto;" data-options="">
						  ...
						  <fieldset>
							<legend><?php echo lang("Validation.insertequip"); ?></legend>
                                                        <legend id='infoLegend' name='infoLegend' style='border-bottom:0px;'></legend>
							<div class="control-group">
							  <label class="control-label" for="typeahead"><?php echo lang("Validation.insertequip"); ?> </label>
							  <div class="controls">
							...
							<div class="form-actions">
							  <button type="submit" onclick='event.preventDefault();submitFormEquipment();' class="btn btn-primary"><?php echo lang("Validation.savedata"); ?></button>
