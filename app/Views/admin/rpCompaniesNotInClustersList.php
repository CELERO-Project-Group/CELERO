<script>
   function saveReport() {
        ...
        if($('#company_dropdown').combobox('getValue') > 0) { 
            document.getElementById('myFrame').setAttribute('src','http://88.249.18.205:8445/jasperPhpEcoman/master/index.php?IndustrialZoneId='+$('#company_dropdown').combobox('getValue')+'&Rapor_ID=10');
            //document.getElementById('myFrame').setAttribute('src','http://88.249.18.205:8445/jasperPhpEcoman/master/index.php?company_id=132&Rapor_ID=3');
                ...
                noty({text: '<?php echo lang("Validation.selectzone"); ?>', type: 'warning'});
        }
    }
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('admin/rpCompaniesNotInClustersList'); ?>"><?php echo lang("Validation.reportcompaniesnotinclusterslink"); ?></a>
					</li>
				</ul>
			</div>
			...
			<div class="sortable row-fluid">
				...
				<a data-rel="tooltip" title="" class="well span3 top-block" href="#">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> <?php echo lang("Validation.notypickzone"); ?></h2>
						<div class="box-icon">
							...
							<!--<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>-->
                                        ...
                                        <div class="box-content" style='padding: 0px;'>
                                                <div id="p2" class="easyui-panel" style="height:250px;" title="<?php echo lang("Validation.notypickzone"); ?>" 
