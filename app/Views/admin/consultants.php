<script>
    ...
    function deleteEditView(consultant_id) {
         ...
         $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                             ...
                             noty({text: '<?php echo lang("Validation.notyzonecondeleted"); ?>', type: 'success'});
    ...
    function updateReport() {
        ...
        $('#ff').form({
            ...
            success:function(data){
                noty({text: '<?php echo lang("Validation.notyzoneconupdated"); ?>', type: 'success'});
                         $('#tt_grid').datagrid('reload');
                         $.messager.progress('close');
     ...
     function saveReport() {
            ...
            $('#ff').form({
                ...
                success:function(data){
                             ...
                             noty({text: '<?php echo lang("Validation.delete"); ?>Consultant inserted succesfully', type: 'success'});
                             $('#tt_grid').datagrid('reload');
                             $.messager.progress('close');
            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                  ...
                  if(data["found"]==true) {
                      ...
                      if(data["id"]>0) {
                          noty({text: '<?php echo lang("Validation.notyzoneconinserted"); ?>', type: 'success'});
                      } else {
                          noty({text: '<?php echo lang("Validation.notyzoneconinsertedbefore"); ?>', type: 'warning'});
                      }
                      
                  } else if(data["found"]==false) {         
                      //$.messager.alert('Insert failed','Failed to insert Flow Family !','error');
                      noty({text: '<?php echo lang("Validation.notyzoneconnotinserted"); ?>', type: 'error'});  
                  }   
                },
    ...
    jQuery(document).ready(function() {
         ...
         $('#tt_grid').datagrid({
            ...
            scroll : true,
            columns:[[
                  {field:'name',title:'<?php echo lang("Validation.name"); ?>',width:100,sortable:true},
                  {field:'surname',title:'<?php echo lang("Validation.surname"); ?>',width:100,sortable:true},
                  {field:'email',title:'<?php echo lang("Validation.email"); ?>',width:100,sortable:true},
                  {field:'phone_num_1',title:'<?php echo lang("Validation.phone"); ?>',width:100,sortable:true},
                  {field:'fax_num',title:'<?php echo lang("Validation.fax"); ?>',width:100,sortable:true},
                ...
                {field:'edit',title:'<?php echo lang("Validation.edit"); ?>',width:50,align:'center',
                    formatter:function(value,row,index){
                        ...
                        var x = '<a href="" class="easyui-linkbutton" \n\
                                    iconCls="icon-save" \n\
                                    onclick="reportEditView(\''+row.name+'\',\''+row.surname+'\', \''+row.email+'\', \''+row.fax_num+'\',\''+row.phone_num_1+'\',  '+row.industrial_zone_id+');event.preventDefault();"><?php echo lang("Validation.edit"); ?> </a>';
                        //return e+d;
                        return x;
                ...
                {field:'delete',title:'<?php echo lang("Validation.delete"); ?>',width:50,align:'center',
                    formatter:function(value,row,index){
                        ...
                        var x = '<a href="" class="easyui-linkbutton" \n\
                                    iconCls="icon-save" \n\
                                    onclick="deleteEditView('+row.id+');event.preventDefault();"><?php echo lang("Validation.delete"); ?></a>';
                        //return e+d;
                        return x;
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('admin/consultants'); ?>"><?php echo lang("Validation.zoneconsultantslink"); ?></a>
					</li>
				</ul>
			</div>
			...
			<div class="sortable row-fluid">
				...
				<a data-rel="tooltip" title="" class="well span3 top-block" href="#">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i><?php echo lang("Validation.insertconsultant"); ?> </h2>
						<div class="box-icon">
							...
							<!--<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>-->
                                        ...
                                        <div class="box-content" style='padding: 0px;'>
                                                <div id="p2" class="easyui-panel"  title="<?php echo lang("Validation.consultantinfo"); ?>" 
                        ...
                        <div class="row-fluid sortable">
                            <div class="box span12">
                                    <div class="box-header well" data-original-title>
                                            <h2><i class="icon-th"></i><?php echo lang("Validation.insertconsultant"); ?> </h2>
                                            <div class="box-icon">
                                        ...
                                        <div class="row-fluid" >
                                            ...
                                            <div class="span12">
                                                <div id="p2" class="easyui-panel"  
                                                     title="<?php echo lang("Validation.consultant"); ?>" 
