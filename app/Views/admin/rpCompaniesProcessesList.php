		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('admin/rpCompaniesProcessesList'); ?>"><?php echo lang("Validation.reportcompanyprocesseslink"); ?></a>
					</li>
				</ul>
			</div>
                                                            ...
                                                            <div style="margin-left:-8px;">
                                                                ...
                                                                <input class="easyui-combobox" 
                                                                    ...
                                                                    data-options="
                                                                            ...
                                                                            url :'../../../../Proxy/SlimProxyAdmin.php?url=getCompaniesInClusters_rpt',
