<script>
   function saveReport() {
        ...
        if($('#company_dropdown').combobox('getValue') > 0) { 
            document.getElementById('myFrame').setAttribute('src','http://88.249.18.205:8445/jasperPhpEcoman/master/index.php?project_id='+$('#company_dropdown').combobox('getValue')+'&Rapor_ID=15');
            //document.getElementById('myFrame').setAttribute('src','http://88.249.18.205:8445/jasperPhpEcoman/master/index.php?company_id=132&Rapor_ID=3');
                ...
                noty({text: '<?php echo lang("Validation.selectcompany"); ?>', type: 'warning'});
        }
    }
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('admin/rpCompaniesProjectDetailsList'); ?>"><?php echo lang("Validation.reportzonecompanyprojectdetailslink"); ?></a>
					</li>
				</ul>
			</div>
			...
			<div class="sortable row-fluid">
				...
				<a data-rel="tooltip" title="" class="well span3 top-block" href="#">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> <?php echo lang("Validation.notypickproject"); ?></h2>
						<div class="box-icon">
							...
							<!--<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>-->
                                        ...
                                        <div class="box-content" style='padding: 0px;'>
                                                <div id="p2" class="easyui-panel" style="height:250px;" title="<?php echo lang("Validation.notypickproject"); ?>" 
                                                        ...
                                                        <div style="padding:10px 60px 20px 60px">
                                                            ...
                                                            <div style="margin-left:-8px;">
                                                                <label style="margin-right: 17px;
                                                                                padding-bottom: 3px;"><?php echo lang("Validation.projects"); ?>:</label>
                                                                <input class="easyui-combobox" 
                                                                    name="company_dropdown" id="company_dropdown"
                                                                    data-options="

                                                                            url :'../../../../Proxy/SlimProxyAdmin.php?url=getProjects_rpt',
