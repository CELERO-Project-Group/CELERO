<script>
   function saveReport() {
        ...
        if($('#company_dropdown').combobox('getValue') > 0) { 
            document.getElementById('myFrame').setAttribute('src','http://88.249.18.205:8445/jasperPhpEcoman/master/index.php?IndustrialZoneId='+$('#company_dropdown').combobox('getValue')+'&Rapor_ID=13');
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('admin/rpConsultantsList'); ?>"><?php echo lang("Validation.reportconsultantslink"); ?></a>
					</li>
				</ul>
			</div>
