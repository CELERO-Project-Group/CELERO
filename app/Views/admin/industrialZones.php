<script>
    function updateReport() {
        ...
        $('#ff').form({
            ...
            url: '../../../../slim2_ecoman_admin/report.php/updateIndustrialZones_rpt',
            queryParams : {
            ...
            success:function(data){
                ...
                {
                    if(jsonObj["id"]>0) {
                         noty({text: '<?php echo lang("Validation.notyzoneupdated"); ?>', type: 'success'});
                         $('#tt_grid').datagrid('reload');
                         $.messager.progress('close');
                     } else {
                         noty({text: '<?php echo lang("Validation.notyzoneinsertedbefore"); ?>', type: 'warning'});
                         $('#tt_grid').datagrid('reload');
                         $.messager.progress('close');
                     }
                    ...
                    noty({text: '<?php echo lang("Validation.notyzonenotupdated"); ?>', type: 'error'}); 
    ...
    function reportEditView(report_name, report_id) {
     ...
     function deleteEditView(report_name, report_id) {
         ...
         $.messager.progress();
         $.ajax({
                url: '../../../../slim2_ecoman_admin/report.php/deleteIndustrialZones_rpt',
                type: 'POST',
                dataType : 'json',
                data: { url:'deleteIndustrialZones_rpt',
                id : report_id,
                name : report_name},
                success: function(data, textStatus, jqXHR) {
                    
                             noty({text: '<?php echo lang("Validation.notyzonedeleted"); ?>', type: 'success'});
                             $('#tt_grid').datagrid('reload');
                             $.messager.progress('close');
     ...
     function saveReport() {
            ...
            $('#ff').form({
                ajax : true,
                //url:'../../../../slim2_ecoman_admin/',
                url: '../../../slim2_ecoman_admin/report.php/insertIndustrialZones_rpt',
                queryParams : {
                    //url : 'insertReport_rpt',
                    //attr : attrStr,
                    name : $('#tt_textReportName').textbox('getText'),
                ...
                success:function(data){
                    var jsonObj = $.parseJSON(data);
                             ...
                             noty({text: '<?php echo lang("Validation.notyzoneinserted"); ?>', type: 'success'});
                             $('#tt_grid').datagrid('reload');
                             $.messager.progress('close');
            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                  ...
                  if(data["found"]==true) {
                      ...
                      noty({text: '<?php echo lang("Validation.notyzonenotinserted"); ?>', type: 'error'});  
                      $('#tt_tree').tree('reload');
                  }   
                },
    ...
    jQuery(document).ready(function() {
         ...
         $('#tt_grid').datagrid({
            url :'../../../Proxy/SlimProxyAdmin.php',
            queryParams : { url : 'getIndustrialZonesGrid_rpt',
            ...
            scroll : true,
            columns:[[
                  {field:'name',title:'<?php echo lang("Validation.zoneslink"); ?>',width:300,sortable:true},
                ...
                {field:'edit',title:'<?php echo lang("Validation.edit"); ?>',width:50,align:'center',
                    formatter:function(value,row,index){
                        ...
                        var x = '<a href="" class="easyui-linkbutton" \n\
                                    iconCls="icon-save" \n\
                                    onclick="reportEditView(\''+row.name+'\','+row.id+' );event.preventDefault();"><?php echo lang("Validation.edit"); ?></a>';
                        //return e+d;
                        return x;
                ...
                {field:'delete',title:'<?php echo lang("Validation.delete"); ?>',width:50,align:'center',
                    formatter:function(value,row,index){
                        ...
                        var x = '<a href="" class="easyui-linkbutton" \n\
                                    iconCls="icon-save" \n\
                                    onclick="deleteEditView(\''+row.name+'\','+row.id+' );event.preventDefault();"><?php echo lang("Validation.delete"); ?> </a>';
                        //return e+d;
                        return x;
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('admin/industrialZones'); ?>"><?php echo lang("Validation.reportzoneequipmentlink"); ?></a>
					</li>
				</ul>
			</div>
			...
			<div class="sortable row-fluid">
				...
				<a data-rel="tooltip" title="" class="well span3 top-block" href="#">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i><?php echo lang("Validation.insertzone"); ?> </h2>
						<div class="box-icon">
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<!--<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>-->
						</div>
                                        ...
                                        <div class="box-content" style='padding: 0px;'>
                                                <div id="p2" class="easyui-panel" style="height:250px;" title="<?php echo lang("Validation.zone"); ?>" 
                                                      ...
                                                      <form id="ff" method="post">
                                                        <div style="padding:10px 60px 20px 60px">
                                                            <div style="margin-bottom: 4px;margin-left: -8px;">
                                                                <label style="margin-right:18px;"><?php echo lang("Validation.zone"); ?>:</label>
                        ...
                        <div class="row-fluid sortable">
                            <div class="box span12">
                                    <div class="box-header well" data-original-title>
                                            <h2><i class="icon-th"></i><?php echo lang("Validation.zoneslink"); ?> </h2>
                                            <div class="box-icon">
                                        ...
                                        <div class="row-fluid" >
                                            ...
                                            <div class="span12">
                                                <div id="p2" class="easyui-panel"  
                                                     title="<?php echo lang("Validation.zoneslink"); ?>" 
