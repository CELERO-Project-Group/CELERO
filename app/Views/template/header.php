...
<body>
  ...
  <nav class="navbar navbar-default navbar-lg" style="margin-bottom:0px;">
    ...
    <ul class="nav navbar-nav navbar-left ust-nav">
      <li class="navtus" data-rel="about"><a id="l0" href="#"><i class="fa fa-info-circle"></i>
          <?= lang("Validation.about"); ?>
        </a></li>
  ...
  <div class="content-container" style="margin-bottom: 20px;display: block;height: 52px;">
    ...
    <ul id="about" class="nav navbar-nav alt-nav" style="display:none;">
      ...
      <li><a href="<?= base_url('functionalities'); ?>"><i class="fa fa-dashboard"></i>
          <?= lang("Validation.functionalities"); ?>
        </a></li>
      <li><a href="<?= base_url('contactus'); ?>"><i class="fa fa-envelope"></i>
          <?= lang("Validation.whoarewe"); ?>
        </a></li>
      <li><a href="<?= base_url('whatwedo'); ?>"><i class="fa fa-question-circle"></i>
          <?= lang("Validation.whatwedo"); ?>
        </a></li>
      <li><a href="<?= base_url('legal'); ?>"><i class="fa fa-gavel"></i>
          <?= lang("Validation.legal"); ?>
        </a></li>
    </ul>

    <ul id="manual" class="nav navbar-nav alt-nav" style="display:none;">
      <li><a href="#" class="nav-info"></a></li>
      <li><a href="<?= base_url('help'); ?>"><i class="fa fa-envelope"></i>
          <?= lang("Validation.usermanual"); ?>, Video Instructions & FAQ
        </a></li>
    </ul>
    ...
    <ul id="profiles" class="nav navbar-nav alt-nav" style="display:none;">
      ...
      if (session()->username):
        ...
        <?php endif ?>
        <li class="head-li"><a href="<?= base_url('myprojects'); ?>" style="padding: 15px 1px 15px 21px" ; color:white;><i
              class="fa fa-globe"></i>
        ...
        <li class="head-li">
          <div class="dropdown">
            <button class="btn-link dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown"
              aria-expanded="true" style="padding: 12px 20px; color:white;">
              <i class="fa fa-plus-circle"></i>
              <?= lang("Validation.add"); ?>
            </button>
            <ul class="dropdown-menu dropdown-red" role="menu" aria-labelledby="dropdownMenu2">
              <li><a href="<?= base_url('newcompany'); ?>">-
                  <?= lang("Validation.createcompany"); ?>
                </a></li>
              <li><a href="<?= base_url('newproject'); ?>">-
      ...
      <?php else: ?>
        ...
        <li class="head-li"><a href="<?= base_url('register'); ?>"><i class="fa fa-plus"></i>
    ...
    <ul id="companies" class="nav navbar-nav alt-nav" style="display:none;">
      ...
      <?php if (isset(session()->username)): ?>
        <li><a href="<?= base_url('mycompanies'); ?>"><i class="fa fa-building-o"></i>
            <?= lang("Validation.mycompanies"); ?>
          </a></li>
        <?php if (isset(session()->project_name)): ?>
          <li><a href="<?= base_url('projectcompanies'); ?>"><i class="fa fa-building-o"></i>
              <?= lang("Validation.projectcompanies"); ?>
            </a></li>
        <?php endif ?>
      <?php endif ?>
      <li><a href="<?= base_url('companies'); ?>"><i class="fa fa-building-o"></i>
          <?= lang("Validation.allcompanies"); ?>
        </a></li>
      <?php if (isset(session()->username)): ?>
        <li class="head-li"><a href="<?= base_url('newcompany'); ?>"><i class="fa fa-plus-square"></i>
            <?= lang("Validation.createcompany"); ?>
          </a></li>
      <?php endif ?>
    </ul>
    ...
    <ul id="projects" class="nav navbar-nav alt-nav" style="display:none;">
      <li><a href="#" class="nav-info"></a></li>
      <?php if (isset(session()->username)): ?>
        <li><a href="<?= base_url('myprojects'); ?>"><i class="fa fa-globe"></i>
            <?= lang("Validation.myprojects"); ?>
          </a></li>
      <?php endif ?>
      <li><a href="<?= base_url('projects'); ?>"><i class="fa fa-globe"></i>
          <?= lang("Validation.allprojects"); ?>
        </a></li>
      <?php if (isset(session()->username)): ?>
        <li><a href="<?= base_url('newproject'); ?>"><i class="fa fa-plus-circle"></i>
            <?= lang("Validation.createproject"); ?>
          </a></li>
      <?php endif ?>
      <?php if (isset(session()->project_id)): ?>
        <li class="pull-right"><a href="<?= base_url('closeproject'); ?>"><i class="fa fa-times-circle"></i>
            <?= lang("Validation.closeproject"); ?>
          </a></li>
        <li class="pull-right"><a href="<?= base_url('project/' . session()->project_id); ?>">
    ...
    <ul id="analysis" class="nav navbar-nav alt-nav" style="display:none;">
      ...
      <?php if (isset(session()->username)): ?>
        <?php if (isset(session()->project_id)): ?>
          ...
          <li class="pull-right"><a href="<?= base_url('project/' . session()->project_id); ?>"
              style="padding: 15px 1px;">Project:
              <?= session()->project_name['name']; ?>
            </a></li>
        <?php else: ?>
          <li><a href="<?= base_url('projects'); ?>">
              <?= lang("Validation.analysisinfo"); ?>
            </a></li>
  ...
  <script type="text/javascript">
    ...
    var logged_in = <?php if (isset(session()->username)) {
      echo "true";
    } else {
      echo "false";
    } ?>
