                                                ...
                                                <th class="th-yw4l" bgcolor="#fefefc">CAPEX (<?= $a['unit_cost']; ?>/a)</th>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="tg-yw4l" rowspan="7" style="vertical-align: middle;">
                                                                            <input type="submit" value="Save" class="btn btn-block btn-info" style="margin-top: 10px; width: 100px; text-align: center;">
                                                                            <!-- cp_or_is variable posted hidden -->
                                                                            <input type="hidden" name="cp_or_is" value="<?= $cp_or_is ?>" >
                                                                        </td>
                                                                        <td class="tg-yw4l" rowspan="7" style="vertical-align: middle;">
                                                                            <?php if (session()->role_id == '1'): ?>
                                                                                <a style="margin-top: 10px; width: 100px; text-align: center;" class="btn btn-danger btn-block delete-btn"
