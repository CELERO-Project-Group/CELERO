<?= $map['js']; ?>
<div class="container">
	<p class="lead"><?= lang("createcompany"); ?></p>
			...
			<div class="col-md-8">
				...
				<div class="form-group">
	 			...
	 			<div class="form-group">
	    			...
	    			<input type="text" class="form-control" id="workPhone" placeholder="<?= lang("workphone"); ?>" value="<?= set_value('workPhone'); ?>" name="workPhone">
	 			</div>
	 			<div class="form-group">
	    			<label for="fax"><?= lang("faxnumber"); ?></label>
	    			<input type="text" class="form-control" id="fax" placeholder="<?= lang("faxnumber"); ?>" value="<?= set_value('fax'); ?>" name="fax">
	 			</div>
				<div class="form-group">
	    			<label for="coordinates"><?= lang("coordinates"); ?></label>
	    			<button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-block btn-primary" id="coordinates" ><?= lang("selectonmap"); ?></button><br>
	    			<div class="row">
		    			<div class="col-md-6">
	 			...
	 			<div class="form-group">
	    			...
	    			<textarea class="form-control" rows="3" name="address" id="address" placeholder="<?= lang("address"); ?>"><?= set_value('address'); ?></textarea>
	 			</div>
	 			<div class="form-group">
	    			<label for="companyDescription"><?= lang("companydescription"); ?></label>
	    			<textarea class="form-control" rows="3" name="companyDescription" id="companyDescription" placeholder="<?= lang("companydescription"); ?>"><?= set_value('companyDescription'); ?></textarea>
	 			</div>
				 <div class="form-group">
	    			<label for="users"><?= lang("assignconsultant"); ?></label>
	 			...
	 			<button type="submit" class="btn btn-primary btn-block"><?= lang("createcompany"); ?></button>
			</div>
		</div>
	</form>
